...
const config: SiteConfig = {
  ...
  socialLinks: {
    ...
    email: 'razrinn19@gmail.com',
    linkedin: 'https://linkedin.com/in/razrinn',
    twitter: 'https://twitter.com/razrinn',
  ...
  giscus: {
    ...
    repoId: 'R_kgDOQIwxiA',
    category: 'Giscus',
    categoryId: 'DIC_kwDOQIwxiM4CxCtr',
